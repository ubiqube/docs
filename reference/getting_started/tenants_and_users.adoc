...
video::tenants_and_users/msa_tenants_and_users.mp4[width=500]
...
image:tenants_and_users/initial_connection.png[Connection Screen]
...
Click on image:tenants_and_users/entity_creation_icon[Entity Creation] to open the "Entity Creation" dialogue and select "Operator" as the Entity Type.
...
video::tenants_and_users/msa_tenant_creation.mp4[width=500]

== Customer Tenant

video::tenants_and_users/msa_customers.mp4[width=500]

Click on image:tenants_and_users/entity_creation_icon[Entity Creation] to open the "Entity Creation" dialogue and select "Customer" as the Entity Type.

Carefully select the Operator Tenant where the Customer will be created.

image:tenants_and_users/customer_creation_form.png[Customer Creation Form]
...
video::tenants_and_users/msa_customer_creation.mp4[width=500]
...
video::tenants_and_users/msa_managers_and_admins.mp4[width=500]
...
video::tenants_and_users/msa_administrator_creation.mp4[width=500]
...
video::tenants_and_users/msa_manager_creation.mp4[width=500]
