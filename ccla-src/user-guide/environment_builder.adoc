...
* Deployments : give the number of deployment associated to this environment + link for a redirection
...
At the environment home page, a topology represents the mapping between applications
