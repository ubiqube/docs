...
Quick Deployment allows user to choose the Application they want to deploy to recommended cloud providers

image:blueprints/Quick_Deployment.png[100]

User will see recommendation clouds and then pick an environment for deployment

image:blueprints/Choose_Cloud.png[400, 400]     

image:blueprints/Pick_an_Environment.png[400, 400]

User needs to add application images and define ports and node ports with proper deployment name

image:blueprints/Add_Application.png[400, 400]

User will see the estimation right before your deployment and can change Hourly, Monthly or Annual
