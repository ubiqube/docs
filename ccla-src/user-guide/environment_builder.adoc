...
image:providers/K8_Cluster.png[400,400]
...
* Save design
Edit the Blueprint design and save this desgin.
* Save environment as blueprint
Once the design is saved. Can be used as a Environment.
* Deploy
Click on Deploy to complete the deployment of the apps over K8 cluster that is selected
