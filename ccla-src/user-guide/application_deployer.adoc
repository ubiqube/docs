...
The *Dashbord* display various informations about the deployment. It can be personalized as explained in xref:navigation_dashboard.adoc[Navigation and Dashboard settings]

The *Operate* section is divided in different tabs :

* *Application :* Displays deployment informations. Provide buttons to Migrate, Tear Down or pause and resume the deployment. 

image:app_deployer/operate_deployments_app.PNG[Applicaton section]

* *Security :* Provide a security dashboard about this deployment, with Web App Scan and Image Scan functions. You can refer you to the xref:security.adoc[Security section] of the documentation.
