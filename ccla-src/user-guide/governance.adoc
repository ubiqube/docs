...
image:SendApproval.png[alt=Governance Menu, width=900px,align="center"]

image:ApprovalMail.png[alt=Governance Menu, width=900px,align="center"]

image:ApprovalsTab.png[alt=Governance Menu, width=900px,align="center"]
