...
image:pop_invite_users.png[alt=Governance Menu, width=700px]

image:invite_user_succeed.png[alt=Governance Menu, width=700px]

*Email*  content should be like

image:email_content.png[alt=Governance Menu, width=450px]
