...
image:governance/settings_view.png[alt=Governance Menu, width=900px,align="center"]
 
 actions performed:
 
* Edit Organisation Name

image:governance/edit_org_name.png[alt=Governance Menu, width=900px,align="center"]

* Accounts

image:governance/org_users.png[alt=Governance Menu, width=900px,align="center"]


* Private Docker Hub Credentials

image:governance/org_credentials.png[alt=Governance Menu, width=900px,align="center"]


* Delete organization

image:governance/delete_org.png[alt=Governance Menu, width=900px,align="center"]
