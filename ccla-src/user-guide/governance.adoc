...
Now to get a *Manager* account you have to *invite it*  , you can check the Invit Users section https://github.com/ubiqube/docs/blob/master/ccla-src/user-guide/governance.adoc#invit-users[here] for more details 
== Get started
