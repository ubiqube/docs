...
* *A design file* to define resources used for the deployment and place components on the environment builder. The design file, by the nature of the component (Provider, Region, Cluster), include MSactivator workflows reference permit the environment creation and the deployment of applications
