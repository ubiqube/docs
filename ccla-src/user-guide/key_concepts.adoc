...
An organization represents a group of people (admin or users) sharing same environements.
An organization is created through the *Get started* form in the cloudclapp login page.
The same instance of CloudclappTM instance can host multiple organization
