...
include::{includedir}/release_ccla_1.1.0.adoc[version 1.1.0]

include::{includedir}/release_ccla_1.0.0.adoc[version 1.0.0]

include::{includedir}/release_ccla_mvp4.adoc[version MVP4]

include::{includedir}/release_ccla_mvp3.adoc[version MVP3]

include::{includedir}/release_ccla_mvp2.adoc[version MVP2]

include::{includedir}/release_ccla_mvp1.adoc[version MVP1]
