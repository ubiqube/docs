...
=== Multi-region blueprint - Prepare Multi clouds / Hybrid clouds

A new blueprint combining multi regions on AZURE with a pre-configured Wordpress and Mysql application
