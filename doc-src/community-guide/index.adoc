...
* I am new to the community. Where can I find the {openmsa_name} Community link:openmsa_code_of_conduct{outfilesuffix}[Code of Conduct]?
...
* I have a question. Which {openmsa_name} email lists will help me find answers?
