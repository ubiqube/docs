...
There are many ways to help the {openmsa_name} project…but first, please read and understand the Community link:openmsa_code_of_conduct{outfilesuffix}[Code of Conduct].
