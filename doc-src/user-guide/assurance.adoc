...
----
cpu_load_1min : 1.3.6.1.4.1.2021.10.1.5.1
cpu_load_5min : 1.3.6.1.4.1.2021.10.1.5.2
cpu_load_15min : 1.3.6.1.4.1.2021.10.1.5.3
----
...
The infrastructure management team (IT/SOC/NOC) can modify the setting of the notifications on a per-event and/or per-subtenant basis. 
...
Alarm Name should be Unique across the SOC and it should not contain space. 
...
You can troubleshoot your alarm configuration by setting the log level of the alerting module to debug more and monitoring the logs.
...
This worklow will execute a process to display the raw log that cause the alarm.
