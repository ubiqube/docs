...
The link:../Assurance/monitoring-profile{outfilesuffix}monitoring profiles] are
...
link:../Managed_Devices_and_Entities/device-history{outfilesuffix}asset
history] up to date.
...
The link:../Assurance/log-analysis{outfilesuffix}log analytic] module is part of
...
The
link:../Managed_Devices_and_Entities/device-history{outfilesuffix}configuration
