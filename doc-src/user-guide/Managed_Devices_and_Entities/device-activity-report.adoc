...
* https://d20ftpvh66dtxq.cloudfront.net/Dev_activity_report.pdf[Media:Dev activity report.pdf]
* https://d20ftpvh66dtxq.cloudfront.net/Dev_activity_report.xls[Media:Dev activity report.xls]
