...
. `git clone --depth 1 https://github.com/ubiqube/quickstart.git`
. `cd quickstart`
...
On link:https://ubiqube.com/quickstart-installation/[ubiqube.com/quickstart-installation,window=_blank], fill the form to receive a trial license by email.
