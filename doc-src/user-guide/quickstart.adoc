...
5. `docker-compose up -d` to download and install the {product_name} containers and create the mini lab.
...
- 2 managed entity to manage the Linux container - linux_me
...
The development of this use case is detailled in this guide: link:../lab-guide/simple_firewall_policy_mngt{outfilesuffix}[Firewall Policy Automation]
