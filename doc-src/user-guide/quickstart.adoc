...
[#step4]
=== Step 4: configure Elasticsearch and Kibana
...
[#step5]
=== Step 5: provision the mini lab with tenants, managed entities, etc.
...
[#step6]
=== Step 6: start using the {product_name}
...
2. `git pull`
3. `git branch -d {revnumber}`
4. `git tag -d {revnumber}`
