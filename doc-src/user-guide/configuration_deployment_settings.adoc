...
A deployment setting is a configuration that links a set of microservices to a set of managed entities.
...
image:deployment_settings_search.png[Deployment Settings Search,width=800px]
