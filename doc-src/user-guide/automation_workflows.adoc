...
image:images/automation_wf_list_add_to_customer.png[Workflow Add to Customer,width=720px]
...
image:images/automation_manager_dashboard.png[Workflow Manager Dashboard,width=720px]
...
image:images/automation_workflow_instance_list.png[Workflow Instance List,width=720px]
...
image:images/automation_workflow_instance_create_form.png[Workflow Create Form,width=720px]
...
image:images/automation_workflow_instance_info.png[Instance Info,width=720]
...
image:images/automation_workflow_instance_history.png[Instance History,width=720]
