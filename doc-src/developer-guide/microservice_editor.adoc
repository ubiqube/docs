...
image:images/deployment_setting_linux_mngt.png[width=720px]
...
image:images/microservice_console_cli_create.png[width=720px]
...
image:images/microservice_console_cli_delete.png[width=720px]
...
image:images/microservice_console_create_instance.png[width=720px]


== XML microservice implementation
