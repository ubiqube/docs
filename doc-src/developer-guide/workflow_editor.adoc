...
- Boolean: will render as a radio button.
- Device: will render as a list with the managed entities.

The "Advanced" tab will allow you to provide more control over the way variable fields are displayed: provide a list of default value, read-only or read-write, visible or hidden, ....
