...
image:../../user-guide/resources/images/configurations_ms_search.png[width=1000px]
...
image:images/microservice_console_information.png[width=1000px] 
...
image:images/deployment_setting_linux_mngt.png[width=1000px]
...
image:images/microservice_console_cli_create.png[width=1000px]
...
image:images/microservice_console_cli_delete.png[width=1000px]
...
image:images/microservice_console_create_instance.png[width=1000px]
