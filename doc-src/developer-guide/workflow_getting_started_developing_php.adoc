...
image:workflow_helloworld_create.png[]

Create a variable "Name" in the tab "Variable".

image:workflow_helloworld_add_variable.png[]
...
image:workflow_helloworld_edit.png[]
...
image:workflow_helloworld_add_task.png[]
...
Before you can test the workflow and execute some processes, you need to link:../user-guide/automation_workflows{outfilesuffix}#workflow_selection[attach the workflow] to your current subtenant.

Use the "+ create instance" action to execute the "create instance" process and create a new instance of your workflow.

image:workflow_helloworld_create_new_instance.png[]

A new instance is available and you can execute the process "print message".

image:workflow_helloworld_new_instance.png[]

The process "print message" will start executing and will executes the tasks sequentially.

image:workflow_helloworld_display_name.png[]
