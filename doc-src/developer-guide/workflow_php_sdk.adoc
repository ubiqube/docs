...
The Microservice may define an IMPORT operation that will be used to read the configuration items from the Managed Entities and import them into the MSA(TM) configuration database.
