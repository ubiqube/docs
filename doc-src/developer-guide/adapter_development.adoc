...
The REST Generic adapter, available on Github at will allow you to integrate practically any vendor that exposes a REST management interface API
This is included in the mini lab (see link:../user-guide/quickstart{outfilesuffix}[Quickstart] for more details)
