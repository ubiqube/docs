...
=== Specific instructions for upgrating from 2.1.0GA to 2.2.0GA
...
To upgrade your {product_name} version {revnumber-prev}, to the version {revnumber}, you need to follow these steps:
