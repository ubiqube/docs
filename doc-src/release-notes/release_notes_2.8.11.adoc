...
image:2.8.11_alarm_count.png[width=700px]
...
image:2.8.11_assurance_filters.png[width=700px]
...
image:2.8.11_new_permissions.png[width=500px]
...
image:2.8.11_ms_multiple_edit.png[width=700px]
