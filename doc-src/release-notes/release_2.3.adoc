...
The {product_name} workflow designer comes with a new set of variable types Such as "Composite"
* Advanced custom UI design with variable type composite 
...
* Composite: advanced custom UI design and rendering.
...
Monitoring profile will allow you to:
 ...
 - Configure custom KPI with threshold crossing based alarms.
