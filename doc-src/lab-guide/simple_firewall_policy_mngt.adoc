...
image:simple_firewall_new_ms.png[width=600px]
...
image:simple_firewall_test_ms.png[width=600px]
...
image:simple_firewall_ms_import_func.png[width=600px]
...
image:simple_firewall_ms_import_new_rule.png[width=600px]
...
image:simple_firewall_new_wf.png[width=600px]
...
- device.0.id: to allow the user to select a list of managed entity to configure - type: Device

image:simple_firewall_wf_variables.png[width=600px]
