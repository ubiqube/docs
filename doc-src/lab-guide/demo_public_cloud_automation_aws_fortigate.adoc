...
This documentation will drive you through the process of installing and using a workflow for automating the deployment of a VNF on AWS public cloud infrastructure. 
...
image:aws_fortigate_ds_info.png[width=800px]
...
image:aws_process_new_service.png[width:800px]
...
image:aws_ec2_marketplace.png[width:800px]
