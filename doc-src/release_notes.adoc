...
- link:./release-notes/release_2.2{outfilesuffix}[version 2.2]
- link:./release-notes/release_2.1{outfilesuffix}[version 2.1]
- link:./release-notes/release_2.0{outfilesuffix}[version 2.0]
