...
video::7VOn1yitGgY[youtube,width=600px,height=360] 

== Overview

The {product_name} provides support for high avalability, based on "Docker Engine Swarm" mode.

image:images/ha_containers.png[overall architecture,width=700px]
...
image:images/ha_profile_1.png[width=250px]

==== Standard: HA platform with mix of activities

image:images/ha_profile_2.png[width=250px]

==== Automation: Execute many WF and BPM

image:images/ha_profile_3.png[width=250px]

==== Assurance: Collect syslogs and monitor entities

image:images/ha_profile_4.png[width=250px]
