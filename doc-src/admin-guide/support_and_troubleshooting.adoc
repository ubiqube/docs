...
IMPORTANT: for monitoring, syslogs, parser, enabling the DEBUG logs may result in a huge volumes of logs so you need to use this carefuly. To revert the configuration use the CLI cmd above with 1 instead of 15.
