...
curl -H "Content-Type:application/json"  -H "Authorization: Bearer "$TOKEN -d '{"name":"Tyrell"}' http://127.0.0.1/ubi-api-rest/customer/$OPERATOR?name=Tyrell&reference=TyrellCorp
